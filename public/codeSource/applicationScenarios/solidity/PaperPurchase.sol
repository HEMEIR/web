...
{ 
	string public place = "No. 186, Taipingfang Avenue, Shishou City" ;
	uint256 public giveTime = 1668643200;
	string public faultName = "" ;
	uint256 public amount = 0 ;
	bool public checkResult = false ;
	uint256 public period = 2592000 ;
	uint public dayNum = 0 ;
	uint256 public Proportion = 30.0 ;
	...
	Person public Buyer = Person("Shishou City Audit Office", payable(0x5B38Da6a701c568545dCfcB03FcB875f56beddC4));
	Person public Seller = Person("Hongxiang Technology, Taipingfang Avenue, Shishou City", payable(0x5B38Da6a701c568545dCfcB03FcB875f56beddC4));
	...
	token public Service = token("paper", "VWN Qin Pin 70g", 60, 190, 11400);
	constructor() {
	}
