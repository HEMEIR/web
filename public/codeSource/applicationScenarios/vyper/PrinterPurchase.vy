...
@deploy
def __init__():
	self.place = "Huangshi No. 2 Middle School"
	self.giveTime = 1671148800
	self.faultName = ""
	self.amount = 0
	...
	self.Buyer = Person (name = "Huangshi No. 2 Middle School", account=0x5B38Da6a701c568545dCfcB03FcB875f56beddC4)
	self.Seller = Person (name = "The Yellowstone Difficult Area Dufenghe Skills Full Line", account=0x5B38Da6a701c568545dCfcB03FcB875f56beddC4)
	self.Arbitration = Ca (name = "arbitration institution", account=0x5B38Da6a701c568545dCfcB03FcB875f56beddC4, key=0, year=0)

	self.Service = token(name="printer", ID="CANONLBP2900+", number=1, unit_price=1600, price=1600)
