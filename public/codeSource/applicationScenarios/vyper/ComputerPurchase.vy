...
def __init__():
	...
	self.Buyer = Person (name = "Boyue Kindergarten, Jianghan District, Wuhan City", account=0x5B38Da6a701c568545dCfcB03FcB875f56beddC4)
	self.Seller = Person (name = "Wuhan Dizhihou Trading Co., Ltd.", account=0x5B38Da6a701c568545dCfcB03FcB875f56beddC4)
	self.Arbitration = Ca (name = "arbitration institution", account=0x5B38Da6a701c568545dCfcB03FcB875f56beddC4, key=0, year=0)

	self.Service = token(name="computer", ID="M43Y", number=1, unit_price=4950, price=4950)
...
def rule3(_checkResult: bool):
	...
	if self.cndition1() or self.condition2():
...
def rule4():
	...
	if self.cndition1() or self.condition2() and not self.isDone("rule3"):
