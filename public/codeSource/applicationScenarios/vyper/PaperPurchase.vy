...
@deploy
def __init__():
	self.place = "No. 186, Taipingfang Avenue, Shishou City"
	self.giveTime = 1668643200
	self.faultName = ""
	self.amount = 0
	...
	self.Buyer = Person (name = "Shishou City Audit Office", account=0x5B38Da6a701c568545dCfcB03FcB875f56beddC4)
	self.Seller = Person (name = "Hongxiang Technology, Taipingfang Avenue, Shishou City", account=0x5B38Da6a701c568545dCfcB03FcB875f56beddC4)
	self.Arbitration = Ca (name = "arbitration institution", account=0x5B38Da6a701c568545dCfcB03FcB875f56beddC4, key=0, year=0)

	self.Service = token(name="paper", ID="VWN Qin Pin 70g", number=60, unit_price=190, price=11400)
