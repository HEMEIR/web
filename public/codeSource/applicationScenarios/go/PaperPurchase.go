...
func (s *PaperPurchase) Init(ctx contractapi.TransactionContextInterface) error {
	Buyer := Person{Name: "Shishou City Audit Office", MSPID: 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4}
	...
	Seller := Person{Name: "Hongxiang Technology, Taipingfang Avenue, Shishou City", MSPID: 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4}
	...
	Service := token{Name: "paper", ID: "VWN Qin Pin 70g", Number: 60, Unit_price: 190, Price: 11400}
	...
	s.contractMessage = &ContractMessage{
		Status:      "start",
		Place:       "No. 186, Taipingfang Avenue, Shishou City",
		GiveTime:    1668643200,
		FaultName:   "",
		Amount:      0,
		CheckResult: false,
...
// Function: operation1
func (s *PaperPurchase) operation1(ctx contractapi.TransactionContextInterface) error {
...
// Function: operation2
func (s *PaperPurchase) operation2(ctx contractapi.TransactionContextInterface) error {
	// Update contract state
...
func (s *PaperPurchase) condition1(ctx contractapi.TransactionContextInterface) bool {
	if isDone(ctx, "rule2", s) && !isTime(s.functionFinishTime["rule2"]+60*60*24*1) {
		return true
	}
	return false
}
func (s *PaperPurchase) condition2(ctx contractapi.TransactionContextInterface) bool {
	if isDone(ctx, "rule2_2", s) && !isTime(s.functionFinishTime["rule2_2"]+60*60*24*1) {
		return true
	}
	return false
}
func (s *PaperPurchase) rule2(ctx contractapi.TransactionContextInterface) {
...
func (s *PaperPurchase) rule2_2(_dayNum int64, ctx contractapi.TransactionContextInterface) {
...
func (s *PaperPurchase) rule2_3(ctx contractapi.TransactionContextInterface) {
...
func (s *PaperPurchase) rule3(_checkResult bool, ctx contractapi.TransactionContextInterface) {
...
func (s *PaperPurchase) rule4(ctx contractapi.TransactionContextInterface) {
...
func (s *PaperPurchase) rule5(_faultName string, _amount float64, ctx contractapi.TransactionContextInterface) {
...
func (s *PaperPurchase) rule6(ctx contractapi.TransactionContextInterface) {
...
func (s *PaperPurchase) rule7(ctx contractapi.TransactionContextInterface) {
...
// 检查某个功能是否已经执行
func isDone(ctx contractapi.TransactionContextInterface, functionName string, s *PaperPurchase) bool {
...
func changeRule(expressionName string, s *PaperPurchase) {
	// 更新 functionStatus
