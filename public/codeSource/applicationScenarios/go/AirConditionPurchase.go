...
type AirConditionPurchase struct {
...
func (s *AirConditionPurchase) Init(ctx contractapi.TransactionContextInterface) error {
	Buyer := Person{Name: "Hubei Industrial Vocational and Technical College", MSPID: 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4}
	...
	Seller := Person{Name: "Shiyan Shengda Feike Industry and Trade Co., Ltd.", MSPID: 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4}
	...
	Service := token{Name: "GREE AirCondition", ID: "1KFR-72LW/(72542)FNhAa -B1JYO1", Number: 1, Unit_price: 6800, Price: 6800}
...
// Function: operation1
func (s *AirConditionPurchase) operation1(ctx contractapi.TransactionContextInterface) error {
...
// Function: operation2
func (s *AirConditionPurchase) operation2(ctx contractapi.TransactionContextInterface) error {
	// Update contract state
...
func (s *AirConditionPurchase) condition1(ctx contractapi.TransactionContextInterface) bool {
	if isDone(ctx, "rule2", s) && !isTime(s.functionFinishTime["rule2"]+60*60*24*5) {
		return true
	}
	return false
}
func (s *AirConditionPurchase) condition2(ctx contractapi.TransactionContextInterface) bool {
	if isDone(ctx, "rule2_2", s) && !isTime(s.functionFinishTime["rule2_2"]+60*60*24*5) {
		return true
	}
	return false
}
func (s *AirConditionPurchase) rule2(ctx contractapi.TransactionContextInterface) {
...
func (s *AirConditionPurchase) rule2_2(_dayNum int64, ctx contractapi.TransactionContextInterface) {
...
func (s *AirConditionPurchase) rule2_3(ctx contractapi.TransactionContextInterface) {
...
func (s *AirConditionPurchase) rule3(_checkResult bool, ctx contractapi.TransactionContextInterface) {
...
func (s *AirConditionPurchase) rule4(ctx contractapi.TransactionContextInterface) {
...
func (s *AirConditionPurchase) rule5(_faultName string, _amount float64, ctx contractapi.TransactionContextInterface) {
...
func (s *AirConditionPurchase) rule6(ctx contractapi.TransactionContextInterface) {
...
func (s *AirConditionPurchase) rule7(ctx contractapi.TransactionContextInterface) {
...
// 检查某个功能是否已经执行
func isDone(ctx contractapi.TransactionContextInterface, functionName string, s *AirConditionPurchase) bool {
...
func changeRule(expressionName string, s *AirConditionPurchase) {
	// 更新 functionStatus
...
func main() {
	...
	contract := new(AirConditionPurchase)
