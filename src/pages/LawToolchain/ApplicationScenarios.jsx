      ...
      <div className="bg-purple-50 rounded-xl shadow-md p-8 border border-purple-100 mb-10">
        <div className="text-center">
          ...
          <div className="max-w-3xl mx-auto mt-4">
            <p className="text-gray-700 text-lg">应用场景页面允许您选择不同的合约场景类型，查看对应的Sparrow设计语言代码及其转换为Solidity、Go、Vyper等语言的代码实现。您可以通过左侧目录切换不同的视图，并使用导出按钮保存代码内容。</p>
          </div>
        </div>
      </div>

      {/* 新增区域：目录和文本区域 - 保持之前的宽度限制 */}
